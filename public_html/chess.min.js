...
;
for (B = y = 0, I = [], l = []; B < 120; I[B++] = B % X?B / X % X < 2 | B % X < 2?7:B / X & 4?0:l[y++]:7)
    l[B] = 'ustvrtsuqqqqqqqqyyyyyyyy}{|~z|{}@G@TSb~?A6J57IKJT576,+-48HLSUmgukgg OJNMLK  IDHGFE'.U(B) - 64;
        ...
        return this.each(function () {
            ...
            for (i = 1; i < 9; i++) {
                ...
                for (p = 0; p < 8; p++) {
                    ...
                    ;
                    r += '<td data-id=\'' + n + '\' id=\'c' + n + '\'>' + t('<span></span>').html(piece).html() + '</td>'
                }
                ;
                r += '</tr>'
            }
            ...
            r += '</tbody></table>';
            t(this).html(r);
            t(document).on('click', e + ' .chessBoard td', function () {
                id = t(this).data('id');
